...
int fragment_reco_fixedbrho(){
  ...
  c->cd(4);
  h_fragaoq_proj->Draw();
  c -> Print("./tofw/output/fragment_reco_r3bmeeting20_ch2.pdf");
  delete c;
  //
  p->Close();
  delete ch;
...
int brho_corr(){
  ...
  fragbrhostring="((Mw3_X - (108.147723) - (Mw2_X-Mw1_X) *(7.365536))+ (- (6.988648) - Mw2_X *(0.800182))+ (- (-13.404625) - (Mw2_Y-Mw1_Y) *(-0.331842))+ (- (-0.308584) - Mw1_Y *(0.052478))-(-1360.643528))/(150.243544)";
  ...
  c->cd(11);
  TH2F* h_brho_corr = new TH2F("h_brho_corr", "h_brho_old_new", 500, 7.5, 9.3,500, 7.5, 9.3);
  ...
  h_brhobrho = new TH2D("hbrhobrho", "Brho correlation in FRS and Cave; Brho FRS /Tm; Brho Cave /Tm", 500, 7.5, 9.3, 500, 7.5, 9.3);
