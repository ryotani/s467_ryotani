...
void main_online()
{
    ...
    TString filename = "/media/audrey/COURGE/SOFIA/ANALYSE/SOFIA3/data/202002_s467/main0341_0001.lmd";


    // Output file ------------------------------------------
    TString outputFileName = "data_0341_s467_online.root";
    ...
    if (fSci){
      ...
      unpackWRSofia = new R3BSofWhiterabbitReader((EXT_STR_h101_WRSOFIA*)&ucesb_struct.wrsofia, offsetof(EXT_STR_h101, wrsofia), 0xe00);
    }
